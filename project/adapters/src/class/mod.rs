...
impl PgClassRepo {
    ...
    async fn update(&self, entity: Entity) -> Result<Classes, anyhow::Error> {
        ...
        query
            ...
            .and_where(Expr::col(ClassesIden::Id).is(entity.id.value))
            .returning_all();
...
impl class::Repo for PgClassRepo {
    ...
    async fn find(&mut self, id: EntityId) -> Result<Option<Entity>, anyhow::Error> {
        ...
        query
            ...
            .column(Asterisk)
            .and_where(Expr::col(ClassesIden::Id).is(id.value));
    ...
    async fn list_by_curriculum_module(
        ...
        query
            .from(ClassesIden::Table)
            .column(Asterisk)
            .and_where(Expr::col(ClassesIden::CurriculumModuleId).is(curriculum_module_id.value));
