...
impl PgCurriculumModuleRepo {
    ...
    async fn update(&self, entity: Entity) -> Result<CurriculumModules, anyhow::Error> {
        ...
        query
            ...
            .and_where(Expr::col(CurriculumModulesIden::Id).is(entity.id.value))
            .returning_all();
...
impl curriculum_module::Repo for PgCurriculumModuleRepo {
    ...
    async fn find(&mut self, id: EntityId) -> Result<Option<Entity>, anyhow::Error> {
        ...
        query
            ...
            .column(Asterisk)
            .and_where(Expr::col(CurriculumModulesIden::Id).is(id.value));
    ...
    async fn list_by_discipline_id(
        ...
        query
            .from(CurriculumModulesIden::Table)
            .column(Asterisk)
            .and_where(Expr::col(CurriculumModulesIden::DisciplineId).is(discipline_id.value));
    ...
    async fn list_by_curriculum_id(
        ...
        query
            .from(CurriculumModulesIden::Table)
            .column(Asterisk)
            .and_where(Expr::col(CurriculumModulesIden::CurriculumId).is(curriculum_id.value));
