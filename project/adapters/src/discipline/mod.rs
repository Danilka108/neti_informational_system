...
impl PgDisciplineRepo {
    ...
    async fn update(&self, entity: Entity) -> Result<Disciplines, anyhow::Error> {
        ...
        query
            ...
            .and_where(Expr::col(DisciplinesIden::Id).is(entity.id.value))
            .returning_all();
...
impl discipline::Repo for PgDisciplineRepo {
    ...
    async fn find(&mut self, id: EntityId) -> Result<Option<Entity>, anyhow::Error> {
        ...
        query
            ...
            .column(Asterisk)
            .and_where(Expr::col(DisciplinesIden::Id).is(id.value));
    ...
    async fn find_by_name(&mut self, name: String) -> Result<Option<Entity>, anyhow::Error> {
        ...
        query
            .from(DisciplinesIden::Table)
            .column(Asterisk)
            .and_where(Expr::col(DisciplinesIden::Name).is(name));
    ...
    async fn list_by_department_id(
        ...
        query
            .from(DisciplinesIden::Table)
            .column(Asterisk)
            .and_where(Expr::col(DisciplinesIden::DepartmentId).is(department_id.value));
